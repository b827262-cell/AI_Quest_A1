...
/**
 * Source-independent contract between ingestion and retrieval.
 * Deterministic identity, timestamp and ACL fields must come from trusted
 * source data; LLM enrichment may only add metadata.
 */
