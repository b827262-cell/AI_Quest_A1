...
export function providerErrorMessage(error: unknown): string {
  ...
  if (categorized.category === "auth_required" || categorized.category === "origin_forbidden" || categorized.category === "network_error" || (error instanceof ApiHttpError && error.status >= 500)) {
